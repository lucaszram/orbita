 ...
 * `src/routes/v492/reading-transitos` (`.tsx` nativo → redirección a
 * `/transitos`, `.web.tsx` web → la lectura por área de siempre).
 *
 ...
 */
export { default } from "@/routes/v492/reading-transitos";
