 ...
 * `src/routes/v492/reading-rueda` (`.tsx` nativo → redirección a
 * `/perfil/carta/completa`, `.web.tsx` web → la rueda de siempre).
 *
 ...
 */
export { default } from "@/routes/v492/reading-rueda";
