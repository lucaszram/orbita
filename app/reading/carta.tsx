 ...
 * `src/routes/v492/reading-carta` (`.tsx` nativo → redirección a
 * `/perfil/carta/completa`, `.web.tsx` web → la tabla de siempre).
 *
 ...
 */
export { default } from "@/routes/v492/reading-carta";
