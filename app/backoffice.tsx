 ...
 * `src/routes/v492/backoffice` (`.tsx` nativo → redirección a Hoy, `.web.tsx`
 * web → la herramienta interna de siempre, con su interruptor).
 *
 ...
 */
export { default } from "@/routes/v492/backoffice";
