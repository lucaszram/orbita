...
export default function IndexRoute() {
  ...
  /**
   * ORDEN, no preferencia.
   *
   * El `return` de la landing estaba ANTES del bloqueo, así que el bloqueo era
   * código inalcanzable en web: con una eliminación a medias en disco, la web
   * dibujaba la landing con su `AccountGate` —que redirige a la app si hay
   * sesión— y dejaba entrar. La decisión vive en `bootGateSurface`, compartida
   * con la variante nativa y probada como función pura.
   */
