 ...
 *
 * Pantalla exclusiva de la web: en nativo V4.9.2 el detalle del tránsito
 * principal es el arco de Hoy, con sus fechas reales y su trazabilidad, así que
 * la redirección vive en el módulo hermano `reading-transito.tsx` que Metro
 * resuelve fuera de web.
 */
