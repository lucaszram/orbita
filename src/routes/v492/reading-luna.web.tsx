 ...
 *
 * Pantalla exclusiva de la web: en nativo V4.9.2 la fase lunar se lee sobre TU
 * carta (casa y tema) en `/hoy/luna`, así que la redirección vive en el módulo
 * hermano `reading-luna.tsx` que Metro resuelve fuera de web.
 */
