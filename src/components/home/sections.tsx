...
const styles = StyleSheet.create({
  ...
  heroImg: { height: 520, left: -64, position: "absolute", top: -96, width: 520 },
  heroFade: { height: 420, left: 0, position: "absolute", right: 0, top: 0 },
  heroContent: { paddingBottom: orbita.spacing.lg, paddingHorizontal: G, paddingTop: 222 },
