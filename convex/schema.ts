...
export default defineSchema({
  ...
  relationshipProfiles: defineTable({
    ...
    // CORE-212 (aditivo): nivel de datos declarado y la carta normalizada de
    // la persona tal como la devolvió el proveedor (nunca el crudo). El tipo
    // de vínculo, la precisión de la hora, las coordenadas y la zona ya los
    // define la línea de producción más arriba (reconciliación CORE-247).
