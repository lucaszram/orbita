...
- **Bloqueo editorial:** el repositorio todavía no contiene el catálogo definitivo de 156 rituales aprobados (78 cartas × 2 orientaciones). El fast path usa por ahora el fallback estructural completo existente; no se promueve a producción como contenido definitivo hasta incorporar/aprobar ese catálogo.
- **Estado:** implementado en rama backend; pendiente codegen, deploy exclusivo a Convex dev y medición fría/caliente antes de cualquier aprobación de producción.
