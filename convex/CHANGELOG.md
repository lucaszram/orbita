...
- **Estado:** implementado y validado en backend: typecheck verde, test destructivo 4/4 y suite completa 296/296. Pendiente PR, deploy exclusivo a Convex dev y frontend separado; producción no fue tocada.
