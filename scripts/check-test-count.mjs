 ...
 * borrado.
 *
 * CORE-191 (la sección Hoy) suma 104 casos: 22 en `hoyPrincipal.test.ts`, 42 en
 * `lunaCarta.test.ts` y 40 en `hoySection.test.ts`.
 *
 ...
 */
export const DEFAULT_MINIMUM = 849;
